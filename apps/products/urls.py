...
from .views import (
    HomeView, ProductListView, ProductDetailView, ProductReviewsView, ReviewReplyView, AdvertiseView, FavoriteListCreateView, FavoriteDeleteView, CategoryListView
)
...
urlpatterns = [
    ...
    path('favorites/delete/<int:product_id>/', FavoriteDeleteView.as_view(), name='favorite-delete'),
]

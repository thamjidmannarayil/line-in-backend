"""
Django settings for lineinproject project.
...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["auth", "apps.authentication", "apps.products", "apps.contacts", "apps.bookings", "apps.carts"],
    "custom_links": {},
    "icons": {
...
ROOT_URLCONF = 'lineinproject.urls'
...
WSGI_APPLICATION = 'lineinproject.wsgi.application'
